...
import com.matera.wcc.projeto.rest.v2.dto.CaminhaoDTO;
import com.matera.wcc.projeto.rest.v2.dto.CarroDTO;
import com.matera.wcc.projeto.rest.v2.dto.MotoDTO;
...
@Component
public class V2VeiculosApiDelegateImpl implements V2VeiculosApiDelegate {
    private static final Logger LOGGER = LoggerFactory.getLogger(V2VeiculosApiDelegateImpl.class);

    private final VeiculoService veiculoService;
    private final ModelMapper modelMapper;

    public V2VeiculosApiDelegateImpl(VeiculoService veiculoService, ModelMapper modelMapper) {
    ...
    private URI location(UUID id) {
        URI location = UriComponentsBuilder.fromPath("/v2/veiculos/{id}").build(id.toString());
